  ...
  <header :class="isHome ? 'd-header-home' : 'd-header'">
    <div class="flex items-center h-full px-1 mx-auto max-w-7xl sm:px-3 lg:px-6">
      ...
      <div class="flex items-center flex-1 justify-center lg:justify-start">
        ...
        <div class="md:text-display-6" :class="{ 'text-white': isHome }">Suger</div>
      </div>
      ...
      <div class="flex items-center justify-end gap-1 lg:flex-1">
        <a href="http://console.suger.cloud" class="hidden md:block text-white font-medium mr-6">Sign In</a>
        <a
          href="http://console.suger.cloud/"
          class="hidden md:block p-2 px-4 rounded-md text-white font-medium bg-yellow-500 hover:bg-yellow-400"
          >Try It Free</a
        >
        <!-- <LangSwitcher
